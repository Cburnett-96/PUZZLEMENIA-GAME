...
namespace final
{
    public partial class FormBossNum : Form
    {
...
(
        ...
        public FormBossNum()
        {
            ...
            PictureList.AddRange(new Bitmap[] {
                ...
                Properties.Resources.III,
                Properties.Resources.IV,
                Properties.Resources.V,
                Properties.Resources.VI,
                Properties.Resources.VII,
                Properties.Resources.VIII,
                Properties.Resources.IX,
                Properties.Resources.X,
                Properties.Resources.XI,
                Properties.Resources.XII,
                Properties.Resources.XIII,
                Properties.Resources.XIV,
                Properties.Resources.XV,
                Properties.Resources.XVI,
            ...
            if (NullIndex != inPictureBoxIndex)
            {
                ...
                if (FourBrothers.Contains(NullIndex))
                {
                    ...
                    if (CheckWin())
                    {
                        ...
                        {
                            (this.Owner as Boss).pbxNumber.Visible = false;
                            this.Close();
                        }
                    }
                }
