...
namespace final
{
    public partial class FormBossPic1 : Form
    {
...
int nHeightEllipse // width of ellipse
        ...
        public FormBossPic1()
        {
            ...
            PictureList.AddRange(new Bitmap[] {
                Properties.Resources.m1_1,
                Properties.Resources.m1_2,
                Properties.Resources.m1_3,
                Properties.Resources.m1_4,
                Properties.Resources.m2_1,
                Properties.Resources.m2_2,
                Properties.Resources.m2_3,
                Properties.Resources.m2_4,
                Properties.Resources.m3_1,
                Properties.Resources.m3_2,
                Properties.Resources.m3_3,
                Properties.Resources.m3_4,
                Properties.Resources.m4_1,
                Properties.Resources.m4_2,
                Properties.Resources.m4_3,
                Properties.Resources.m4_4,
            ...
            if (NullIndex != inPictureBoxIndex)
            {
                ...
                if (FourBrothers.Contains(NullIndex))
                {
                    ...
                    if (CheckWin())
                    {
                        ...
                        {
                            (this.Owner as Boss).pbxImage.Visible = false;
                            this.Close();
                        }
                    }
                }
