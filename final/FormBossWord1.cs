...
namespace final
{
    public partial class FormBossWord1 : Form
    {
...
(
        ...
        public FormBossWord1()
        {
            ...
            PictureList.AddRange(new Bitmap[] {
                ...
                Properties.Resources.u5,
                Properties.Resources.u6,
                Properties.Resources.u7,
                Properties.Resources.u8,
                Properties.Resources.u9,
                Properties.Resources.u10,
                Properties.Resources.u11,
                Properties.Resources.u12,
                Properties.Resources.u13,
                Properties.Resources.u14,
                Properties.Resources.u15,
                Properties.Resources.u16,
            ...
            if (NullIndex != inPictureBoxIndex)
            {
                ...
                if (FourBrothers.Contains(NullIndex))
                {
                    ...
                    if (CheckWin())
                    {
                        ...
                        {
                            (this.Owner as Boss).pbxWord1.Visible = false;
                            this.Close();
                        }
                    }
                }
        ...
        {
            DialogResult YesOrNo = new DialogResult();
            YesOrNo = MessageBox.Show("Do you want to Exit?", "Are you Sure?", MessageBoxButtons.YesNo);
            if (YesOrNo == DialogResult.Yes)
            {
                this.Close();
            }
        ...
        {
            MessageBox.Show("GOAL:That for which no one can obtain copyright.\n(UNCOPYRIGHTABLE)", "uncopyrightable");
        }
    }
}
